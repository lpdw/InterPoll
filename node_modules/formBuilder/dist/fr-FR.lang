...
enableOtherMsg = Laisser la possibilité aux utilisateurs d'ajouter un option non listée
...
limitRole = Limiter l'acces à un ou plusieurs des rôles suivants:
...
name = Name
no = Non
noFieldsToClear = Il n'y a pas de champ à retirer
number = Nombre
off = Off
on = On
option = Option
